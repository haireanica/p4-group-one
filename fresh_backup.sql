...
CREATE TABLE `loan` (
  ...
  CONSTRAINT `fk_assetId` FOREIGN KEY (`assetId`) REFERENCES `asset` (`assetId`),
...
CREATE TABLE `maintenance` (
  ...
  KEY `fk_asset_Id` (`assetId`),
  CONSTRAINT `fk_asset_Id` FOREIGN KEY (`assetId`) REFERENCES `asset` (`assetId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-09-18 15:53:15
